...
public class ClaimsDecisioning extends Fragment {
    ...
    public static TextView C_estimations,claim_id,approve,reject,hold,incident_location,incident_description,incident_date,damaged_part;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        damaged_part = rootView.findViewById(R.id.damaged_part);
    ...
    public static class  Auto_Detection extends AsyncTask<Void,Void, JSONObject> {
        ...
        protected void onPostExecute(JSONObject s) {
            ...
            try {
                if (s!=null){
                    C_estimations.setText("$"+s.getString("total_cost"));
                    claim_id.setText(current.getClaimid());
                    damaged_part.setText(s.getString("part"));
...
//                        if(mgeoEvents.get(0).getCategory().equals("severe-weather")){
                        if(mgeoEvents.get(0).getCategory().toLowerCase().contains("weather") ||
                            ...
                            event_1_message.setText("Severe weather - " + mgeoEvents.get(0).getTitle() + " in the locality of the user that might had been the cause of Incident.");
                            ...
                            if (mgeoEvents.get(0).getCategory().equals("concerts")) {
                                ...
                                //event_1_message.setText("There was a concert happening at Stevens Avenue away from the incident loction that might had been the cause of Incident.");
                            }
                            ...
                            event_1_message.setText(mgeoEvents.get(0).getTitle() + " " + mgeoEvents.get(0).getCategory() + " took place at Stevens Avenue");
                        }
                    }
                    if (t==2){
                        ...
                        if(mgeoEvents.get(1).getCategory().toLowerCase().contains("weather") ||
                            ...
                            event_2_message.setText("Severe weather - " + mgeoEvents.get(1).getTitle() + " in the locality of the user that might had been the cause of Incident.");
                            ...
                            event_2_message.setText(mgeoEvents.get(1).getTitle() + " " + mgeoEvents.get(1).getCategory() + " took place at Stevens Avenue");
                        }
                    }
