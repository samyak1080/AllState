...
public class ClaimEstimation extends Fragment {
    ...
    public static TextView C_estimations,claim_id, deductible, customer_amount,damaged_part;
        ...
        protected void onPostExecute(JSONArray claim_amount_details) {
            try {
                if (claim_amount_details!=null)
                {
                    ...
                    Log.e("Request",""+jsonobject.getString("deductible"));
