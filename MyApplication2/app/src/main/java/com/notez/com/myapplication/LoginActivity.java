        ...
        protected void onPostExecute(JSONObject s) {
            try{
                if(s.getString("status").equals("true")) {
                    ...
                    if (s.getString("code").equals("wrong_username"))
                        Toast.makeText(LoginActivity.this,"Username does not exist",Toast.LENGTH_LONG).show();
                    else if (s.getString("code").equals("wrong_password"))
                ...
                Log.e("Exception",e.getMessage());
                Toast.makeText(LoginActivity.this,"Sorry some error occurred. Please check Internet connectivity.",Toast.LENGTH_LONG).show();
            }
