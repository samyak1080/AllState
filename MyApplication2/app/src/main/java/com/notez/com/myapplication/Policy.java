...
public class Policy extends Fragment {
    ...
    public static TextView primary_ind, under_insured_mv_pd, uninsured_mv_bi,show_driver_details;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       /* show_driver_details=rootView.findViewById(R.id.show_driver_details);

        show_driver_details.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
              *//*  final android.app.Fragment mp=new FragmentDriverDetails();
