...
import Adapters.IncidentImageProofAdapter;
...
public class RaiseClaim extends Fragment implements DatePickerDialog.OnDateSetListener {
    ...
    public static  List<File> imageProofList;
    IncidentImageProofAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerView = rootView.findViewById(R.id.incident_image_proof_recycler_view);
        mRecyclerView.setHasFixedSize(false);
        mRecyclerView.setNestedScrollingEnabled(false);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        imageProofList=new ArrayList<File>();
        mAdapter = new IncidentImageProofAdapter(getActivity(), imageProofList);
...
public class  UploadClaim extends AsyncTask<Void,Void,JSONObject>{
    ...
    protected JSONObject doInBackground(Void... voids) {
        ...
        MultipartBody.Builder rt=   new MultipartBody.Builder()
                    .setType(MultipartBody.FORM)
                    .addFormDataPart("no_of_images", RaiseClaim.imageProofList.size()+"")
        ...
        for(int i=0;i<RaiseClaim.imageProofList.size();i++)
            rt.addFormDataPart("image_incident_proof_"+i, RaiseClaim.imageProofList.get(i).getName(), RequestBody.create(MEDIA_TYPE_PNG,finalFile ));



        RequestBody requestBody = rt.build();
